...
class approve_astro extends StatefulWidget {
  final String title_name;
  final String page_id;
  final String page_code;
  const approve_astro({super.key,required this.title_name,required this.page_id,required this.page_code});

  @override
  State<approve_astro> createState() => _approve_astroState();
}

class _approve_astroState extends State<approve_astro> {
  ...
  Future<void> action_button_click(String select_user_id) async {
    loader_file().show_loader();
    final userdetails_response = await Network_data().Approved_TO_live_astro_api(select_user_id);

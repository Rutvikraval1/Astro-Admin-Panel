...
class live_astro extends StatefulWidget {
  final String title_name;
  final String page_id;
  final String page_code;
  const live_astro({super.key,required this.title_name,required this.page_id,required this.page_code});

  @override
  State<live_astro> createState() => _live_astroState();
}

class _live_astroState extends State<live_astro> {
